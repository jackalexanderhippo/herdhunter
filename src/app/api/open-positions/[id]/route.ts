...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const position = await prisma.openPosition.update({
    ...
    data: {
      ...
      ...(body.hiringLead !== undefined && { hiringLead: body.hiringLead?.toString().trim() || null }),
      ...(body.interviewLead !== undefined && { interviewLead: body.interviewLead?.toString().trim() || null }),
